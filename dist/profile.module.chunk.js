...
var ProfileComponent = (function () {
    function ProfileComponent(currentUserService, doctorService, patientService, historyService, pdfmake) {
        ...
        this.currentUser = { _id: '', type: '', health: { doctor: '', patient: '' }, insurance: '' };
        ...
        if (this.currentUser.type == 'patient') {
            this.patientService.getPatientById(this.currentUser._id)
                ...
                var _loop_1 = function (i) {
                    _this.historyService.getHistoryById(_this.currentUserService.currentUser.history[i])
                        .then(function (res) {
                        console.log("res", res);
                        _this.currentUserService.currentUser.history[i] = res;
                    });
                };
                for (var i = 0; i < _this.currentUserService.currentUser.history.length; i++) {
                    _loop_1(i);
                }
...
ProfileComponent = __decorate([
    ...
    __metadata("design:paramtypes", [typeof (_a = typeof __WEBPACK_IMPORTED_MODULE_2__services__["b" /* CurrentUserService */] !== "undefined" && __WEBPACK_IMPORTED_MODULE_2__services__["b" /* CurrentUserService */]) === "function" && _a || Object, typeof (_b = typeof __WEBPACK_IMPORTED_MODULE_2__services__["c" /* DoctorService */] !== "undefined" && __WEBPACK_IMPORTED_MODULE_2__services__["c" /* DoctorService */]) === "function" && _b || Object, typeof (_c = typeof __WEBPACK_IMPORTED_MODULE_2__services__["g" /* PatientService */] !== "undefined" && __WEBPACK_IMPORTED_MODULE_2__services__["g" /* PatientService */]) === "function" && _c || Object, typeof (_d = typeof __WEBPACK_IMPORTED_MODULE_2__services__["e" /* HistoryService */] !== "undefined" && __WEBPACK_IMPORTED_MODULE_2__services__["e" /* HistoryService */]) === "function" && _d || Object, typeof (_e = typeof __WEBPACK_IMPORTED_MODULE_3_ng_pdf_make_pdfmake_pdfmake_service__["a" /* PdfmakeService */] !== "undefined" && __WEBPACK_IMPORTED_MODULE_3_ng_pdf_make_pdfmake_pdfmake_service__["a" /* PdfmakeService */]) === "function" && _e || Object])
], ProfileComponent);
...
ProfileModule = __decorate([
    Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["M" /* NgModule */])({
        ...
        providers: [__WEBPACK_IMPORTED_MODULE_5__services__["g" /* PatientService */], __WEBPACK_IMPORTED_MODULE_5__services__["b" /* CurrentUserService */], __WEBPACK_IMPORTED_MODULE_7_ng_pdf_make__["a" /* PdfmakeService */], __WEBPACK_IMPORTED_MODULE_5__services__["e" /* HistoryService */]],
    })
], ProfileModule);
