...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6_rrule__ = __webpack_require__("../../../../rrule/lib/rrule.js");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6_rrule___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_6_rrule__);
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
var ProfileComponent = (function () {
    function ProfileComponent(authService, userService, historyService, appointmentService, doctorService, procedureService, calendarService, pdfmake, modalService) {
    ...
    ProfileComponent.prototype.ngOnInit = function () {
        ...
        this.authService.initUser().then(function (data) { _this.currentUser = data; _this.generateAppointmentList(); });
    };
    ...
    ProfileComponent.prototype.updateRrule = function (event) {
        ...
        for (var i = 0; i < this.ruleModel.byweekday.length; i++) {
            if (this.ruleModel.byweekday[i]) {
                days.push(i);
            }
        }
        for (var i = 0; i < this.ruleModel.bymonth.length; i++) {
        ...
        this.rrule = new __WEBPACK_IMPORTED_MODULE_6_rrule___default.a(rule);
        console.log(this.rrule.toText());
        console.log(this.rrule.toString());
    };
    // Slots
    ProfileComponent.prototype.createSlot = function () {
        this.updateRrule({});
        console.log('rrule test', this.rrule.options, "5a0528b26836d42dfa945ecc");
        var slot = { rrule: this.rrule.options, procedure: "5a0528b26836d42dfa945ecc" };
        this.calendarService.addSlot(this.currentUser.doctor.calendar._id, slot).then(function (data) { console.log(data); });
    };
    // Appointments
    ProfileComponent.prototype.cancelAppointment = function (appt) {
        var _this = this;
    ...
    ProfileComponent.prototype.acceptAppointment = function (appt) {
        var _this = this;
    ...
    ProfileComponent.prototype.denyAppointment = function (appt) {
        var _this = this;
    ...
    ProfileComponent.prototype.completeAppointment = function (appt) {
        var _this = this;
    ...
    ProfileComponent.prototype.openAppointmentModal = function (appointment, content, type) {
        var _this = this;
    ...
    // Procedures
    ProfileComponent.prototype.openProcedureModal = function (procedure, content, type) {
        var _this = this;
    ...
    ProfileComponent.prototype.updateProcedure = function () {
        var _this = this;
        var command = { $set: { name: this.procedureModel.name,
        ...
        this.procedureService.updateProcedure(this.procedureModel._id, command)
            ...
            _this.authService.initUser()
                .then(function (data2) { _this.currentUser = data2; _this.generateAppointmentList(); _this.modalRef.close(); });
        });
    };
    ProfileComponent.prototype.createProcedure = function () {
        var _this = this;
        this.procedureService.createProcedure(this.procedureModel)
            .then(function (data) {
            _this.doctorService.updateDoctor(_this.currentUser.doctor._id, { $push: { procedures: data.procedure } })
                .then(function (data2) {
                _this.authService.initUser()
                    .then(function (data3) {
                    _this.currentUser = data3;
                    _this.generateAppointmentList();
    ...
    ProfileComponent.prototype.deleteProcedure = function () {
        var _this = this;
        this.procedureService.deleteProcedure(this.procedureModel._id)
            .then(function (data) {
            _this.doctorService.updateDoctor(_this.currentUser.doctor._id, { $pull: { procedures: _this.procedureModel._id } })
                .then(function (data2) {
                _this.authService.initUser()
                    .then(function (data3) {
                    _this.currentUser = data3;
    ...
    ProfileComponent.prototype.viewProcedure = function (procedure) {
    ...
    // Clean up
    ProfileComponent.prototype.generateAppointmentList = function () {
        var _this = this;
        this.appointments = [];
        if (this.currentUser.patient) {
            //console.log(this.authService.currentUser.patient.history)
            for (var _i = 0, _a = this.authService.currentUser.patient.history; _i < _a.length; _i++) {
                var history = _a[_i];
            ...
            this.calendarService.getCalendarById(this.authService.currentUser.doctor.calendar._id)
                .then(function (cal) {
                _this.authService.currentUser.doctor.calendar = cal;
                for (var _i = 0, _a = _this.authService.currentUser.doctor.calendar.appointments; _i < _a.length; _i++) {
    ...
    ProfileComponent.prototype.resetModal = function () {
        //console.log('reset');
...
ProfileComponent = __decorate([
    ...
    __metadata("design:paramtypes", [typeof (_a = typeof __WEBPACK_IMPORTED_MODULE_2__services__["b" /* AuthenticationService */] !== "undefined" && __WEBPACK_IMPORTED_MODULE_2__services__["b" /* AuthenticationService */]) === "function" && _a || Object, typeof (_b = typeof __WEBPACK_IMPORTED_MODULE_2__services__["j" /* UserService */] !== "undefined" && __WEBPACK_IMPORTED_MODULE_2__services__["j" /* UserService */]) === "function" && _b || Object, typeof (_c = typeof __WEBPACK_IMPORTED_MODULE_2__services__["f" /* HistoryService */] !== "undefined" && __WEBPACK_IMPORTED_MODULE_2__services__["f" /* HistoryService */]) === "function" && _c || Object, typeof (_d = typeof __WEBPACK_IMPORTED_MODULE_2__services__["a" /* AppointmentService */] !== "undefined" && __WEBPACK_IMPORTED_MODULE_2__services__["a" /* AppointmentService */]) === "function" && _d || Object, typeof (_e = typeof __WEBPACK_IMPORTED_MODULE_2__services__["d" /* DoctorService */] !== "undefined" && __WEBPACK_IMPORTED_MODULE_2__services__["d" /* DoctorService */]) === "function" && _e || Object, typeof (_f = typeof __WEBPACK_IMPORTED_MODULE_2__services__["i" /* ProcedureService */] !== "undefined" && __WEBPACK_IMPORTED_MODULE_2__services__["i" /* ProcedureService */]) === "function" && _f || Object, typeof (_g = typeof __WEBPACK_IMPORTED_MODULE_2__services__["c" /* CalendarService */] !== "undefined" && __WEBPACK_IMPORTED_MODULE_2__services__["c" /* CalendarService */]) === "function" && _g || Object, typeof (_h = typeof __WEBPACK_IMPORTED_MODULE_3_ng_pdf_make_pdfmake_pdfmake_service__["a" /* PdfmakeService */] !== "undefined" && __WEBPACK_IMPORTED_MODULE_3_ng_pdf_make_pdfmake_pdfmake_service__["a" /* PdfmakeService */]) === "function" && _h || Object, typeof (_j = typeof __WEBPACK_IMPORTED_MODULE_5__ng_bootstrap_ng_bootstrap__["e" /* NgbModal */] !== "undefined" && __WEBPACK_IMPORTED_MODULE_5__ng_bootstrap_ng_bootstrap__["e" /* NgbModal */]) === "function" && _j || Object])
], ProfileComponent);
...
ProfileModule = __decorate([
    Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["M" /* NgModule */])({
        imports: [
            ...
            __WEBPACK_IMPORTED_MODULE_4__shared__["h" /* StatModule */],
        ...
        providers: [__WEBPACK_IMPORTED_MODULE_5__services__["j" /* UserService */], __WEBPACK_IMPORTED_MODULE_5__services__["b" /* AuthenticationService */], __WEBPACK_IMPORTED_MODULE_5__services__["i" /* ProcedureService */], __WEBPACK_IMPORTED_MODULE_5__services__["d" /* DoctorService */],
            __WEBPACK_IMPORTED_MODULE_7_ng_pdf_make__["a" /* PdfmakeService */], __WEBPACK_IMPORTED_MODULE_5__services__["f" /* HistoryService */], __WEBPACK_IMPORTED_MODULE_5__services__["a" /* AppointmentService */], __WEBPACK_IMPORTED_MODULE_5__services__["c" /* CalendarService */]],
    })
], ProfileModule);
