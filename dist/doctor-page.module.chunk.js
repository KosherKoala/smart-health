            ...
            _this.doctorService.getDoctorById(_this.id).then(function (data) {
                ...
                _this.calendarService.getCalendarById(_this.doctor.calendar).then(function (data2) {
                    ...
                    for (var _i = 0, _a = _this.doctor.calendar.slots; _i < _a.length; _i++) {
                        var slot = _a[_i];
                        for (var i = 0; i < slot.rrule.byweekday.length; i++) {
                    ...
                    console.log('recurring', _this.recurringEvents);
                    _this.currentAppointments = _this.doctor.calendar.appointments;
        ...
        this.recurringEvents.forEach(function (event) {
            ...
            rule.all().forEach(function (date) {
                _this.events.push(Object.assign({}, event, {
                    start: new Date(date),
                    end: Object(__WEBPACK_IMPORTED_MODULE_5_date_fns__["addHours"])(new Date(date), Number(event.procedure.duration))
                }));
            });
        });
...
DoctorPageModule = __decorate([
    Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["M" /* NgModule */])({
        ...
        providers: [__WEBPACK_IMPORTED_MODULE_6__services__["e" /* DoctorService */], __WEBPACK_IMPORTED_MODULE_6__services__["c" /* CalendarService */], __WEBPACK_IMPORTED_MODULE_6__services__["a" /* AppointmentService */]]
    })
], DoctorPageModule);
